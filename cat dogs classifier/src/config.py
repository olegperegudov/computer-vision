...
# --------------------------------TRAINING PARAMS--------------------------------
frac=0.5 # this is the amount of original data used for training/validation/testing (low values will run the script faster)
...
# n_epochs
frozen = 3 # number of epochs trained with only last layer's params available for training
unfrozen = 10 # all params are traininable
